...
import { EaiiAnimationCurves, EaiiAnimationDurations } from '@eaii/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${EaiiAnimationDurations.entering} ${EaiiAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${EaiiAnimationDurations.exiting} ${EaiiAnimationCurves.acceleration}`
                }
            }
        )
    ]
