...
@Component({
    selector       : 'eaii-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : eaiiAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EaiiVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'eaii-vertical-navigation-item-collapsed': this.isCollapsed,
            'eaii-vertical-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._eaiiVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._eaiiVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._eaiiVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._eaiiVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: EaiiNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: EaiiNavigationItem, item: EaiiNavigationItem): boolean
    {
