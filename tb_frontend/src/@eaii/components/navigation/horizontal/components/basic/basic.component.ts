...
@Component({
    selector       : 'eaii-horizontal-navigation-basic-item',
    templateUrl    : './basic.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EaiiHorizontalNavigationBasicItemComponent implements OnInit, OnDestroy
{
    ...
    )
    {
        ...
        this.isActiveMatchOptions = this._eaiiUtilsService.subsetMatchOptions;
    }
    ...
    ngOnInit(): void
    {
        ...
        this.isActiveMatchOptions =
            this.item.isActiveMatchOptions ?? this.item.exactMatch
                ? this._eaiiUtilsService.exactMatchOptions
                : this._eaiiUtilsService.subsetMatchOptions;
