...
import { FSDocument, FSDocumentElement } from '@eaii/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'eaii-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'eaiiFullscreen'
})
export class EaiiFullscreenComponent implements OnInit
{
