...
import { EaiiHighlightService } from '@eaii/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[eaii-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'eaiiHighlight'
})
export class EaiiHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _eaiiHighlightService: EaiiHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._eaiiHighlightService.highlight(this.code, this.lang));
